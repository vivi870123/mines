augroup user_plugin_filetype
  ...
  autocmd FileType * if ShouldQuitOnQ() | nmap <buffer> <silent> <expr>  q &diff ? ':qa!<cr>' : ':q<cr>' | endif
	...
	autocmd BufWritePost ~/.config/qutebrowser/config.py !qutebrowser :config-source
	autocmd BufWritePost ~/.config/qutebrowser/themes/darkstar.css !qutebrowser :'set content.user_stylesheets themes/darkstar.css'
	autocmd BufWritePost ~/.config/qutebrowser/themes/default.css !qutebrowser :'set content.user_stylesheets themes/default.css'
